// DemoHighSchoolFootballGame.java
import java.util.Scanner;

public class DemoHighSchoolFootballGame
{
	public static void main(String args[])
	{
		...
		HighSchoolFootballGame hsfootBall = null;
		int numberOfQuarters = 4;
		int team_Score, quarters;
		
		//Identifies the type of football
		System.out.println("\t\t________High School Football________\n\n");
		...
		hsfootBall = new HighSchoolFootballGame(team_Name_1, team_Name_2);
		...
		for (int i = 0; i < numberOfQuarters; i++)
		{
			...
			do
			{
				...
				//loop until filled
			while (!hsfootBall.setTeam_1_Scores(quarters, team_Score));
			...
			do
			{
				...
				//loop until filled
				while (!hsfootBall.setTeam_2_Scores(quarters, team_Score));
		}
		//winner determination
		System.out.println("\nGame Result: \n" + hsfootBall.getGameWinner());		
	}
}
