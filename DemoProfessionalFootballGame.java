// DemoProfessionalFootballGame.java
import java.util.Scanner;

public class DemoProfessionalFootballGame
{
	public static void main(String args[])
	{
		...
		FootballGame footBall = null;
		int numberOfQuarters = 4;
		int team_Score, quarters;
		
		//Identifies the type of football
		System.out.println("\t\t________Professional Football________\n\n");
		...
		footBall = new FootballGame(team_Name_1, team_Name_2, numberOfQuarters);
		...
		for (int i = 0; i < numberOfQuarters; i++)
		{
			...
			do
			{
				...
				//loop until filled
			while (!footBall.setTeam_1_Scores(quarters, team_Score));
			...
			do
			{
				...
				//loop until filled
				while (!footBall.setTeam_2_Scores(quarters, team_Score));
		}
		//winner determination
		System.out.println("\nGame Result: \n" + footBall.getGameWinner());		
	}
}
